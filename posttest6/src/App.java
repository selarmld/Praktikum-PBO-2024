...
public class App {
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            int pilihan = bacaDanValidasiInput(input);
    ...
    public static int bacaDanValidasiInput(BufferedReader input) {
        int angka;
        while (true) {
            try {
                angka = Integer.parseInt(input.readLine().trim());
                return angka;
            } catch (NumberFormatException e) {
                System.out.println("Input tidak valid, silakan masukkan angka.");
            } catch (IOException e) {
                System.out.println("Kesalahan saat membaca input, silakan coba lagi.");
            }
        }
    }
